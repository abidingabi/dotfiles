...
I'd also like to use =elfeed-protocol= to sync with an rss server.
#+begin_src elisp
(elfeed-protocol-enable)
(setq elfeed-use-curl t)
(setq elfeed-protocol-enabled-protocols '(fever))

(setq elfeed-feeds '(("fever+http://abidingabi@rss.priv.dogbuilt.net"
                      :api-url "http://rss.priv.dogbuilt.net/fever/"
                      :use-authinfo t)))
#+end_src
** Email
...
#+begin_src elisp
(add-load-path! "/etc/profiles/per-user/abidingabi/share/emacs/site-lisp/mu4e")
#+end_src
*** Email Directories
...
#+begin_src elisp
(after! mu4e
  (setq sendmail-program "/etc/profiles/per-user/abidingabi/bin/msmtp"
